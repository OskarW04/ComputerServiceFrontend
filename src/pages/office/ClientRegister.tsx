    ...
    <div className="max-w-2xl mx-auto">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Wprowadź dane klienta, aby utworzyć konto.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="pin" value={formData.pin} onChange={handleChange} required placeholder="4 cyfry" maxLength={4} />
            </div>
